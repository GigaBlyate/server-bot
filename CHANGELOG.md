## 3.1.15
- info: added top CPU/RAM processes screen for quick diagnosis from the server information section
- info: added buttons to open process load view directly from the information menu and the server info screen
