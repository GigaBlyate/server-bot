...
Telegram бот для управления Linux сервером. Позволяет отслеживать состояние системы, выполнять обновления, перезагружать сервер, проверять доступность хостов и генерировать пароли.
...
Автоматический запуск при загрузке сервера (systemd)
